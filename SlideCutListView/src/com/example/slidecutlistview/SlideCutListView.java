...
public class SlideCutListView extends ListView {
	...
	/**
	 * 分发事件， 主要做的是判断点击的是哪个item，以及通过postDelayed来设置响应左右滑动的事件
	 * @param display
	 * @return
	 */
	 ...
	 * 我们需要在回调方法removeItem()中移除改Item，然后刷新ListView
	 */
